...
def analyze():
    ...
    decision = decide_risk(
        suspicious=detection_result["anomaly"],
    ...
    result.update(
        {
            ...
            "integrity": integrity,
            "filename": filename,
            "prediction": detection_result["label"] if decision["allow_prediction"] else None,
            "confidence": detection_result["confidence"] if decision["allow_prediction"] else None,
